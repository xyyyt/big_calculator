...
protected :
    std::string calc_arithmetic_expression(std::string_view line)
    {
        ...
        std::list<std::string_view> rpn_expression = arithmetic::to_rpn(line);

        return arithmetic::rpn_evaluate(_operations, rpn_expression);
    }
...
TEST_F(calculate_arithmetic_expression, test)
{
    ...
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression(""),
    ...
    EXPECT_THROW_MSG(
        ...
        "empty arithmetic expression");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression(") 2000 ("),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with closing parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression(" )45  "),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with closing parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("     +17"),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("- 9999    \t"),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("*32    "),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("   / 4"),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("% 87"),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("a + b"),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with unknown character");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("    p12345"),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with unknown character");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("\tn000000"),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with unknown character");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression(" \t   M16"),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot start with unknown character");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("     42abcd"),
        custom_exceptions::parsing_error,
        "error after number");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("  42  a"),
        custom_exceptions::parsing_error,
        "error after number");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("13 \t   (42)"),
        custom_exceptions::parsing_error,
        "error after number");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("13 13"),
        custom_exceptions::parsing_error,
        "error after number");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("5 +"),
        custom_exceptions::parsing_error,
    ...
    EXPECT_THROW_MSG(
        ...
        "error after operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression(" 5 %   % 5"),
        custom_exceptions::parsing_error,
        "error after operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("2---2"),
        custom_exceptions::parsing_error,
        "error after operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("3 *(5) + --42"),
        custom_exceptions::parsing_error,
        "error after operator");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("("),
    ...
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("   4/5   *("),
        custom_exceptions::parsing_error,
        "arithmetic expression cannot end with opening parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression(" 4 / 2 %(+"),
        custom_exceptions::parsing_error,
        "error after opening parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("\t9+2/(   -"),
        custom_exceptions::parsing_error,
        "error after opening parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("(**)"),
        ...
        "error after opening parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("12 )"),
        custom_exceptions::parsing_error,
    ...
    EXPECT_THROW_MSG(
        ...
        "missing opening parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression(" ((((1))))))))"),
        custom_exceptions::parsing_error,
        "missing opening parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("  (1)  42"),
        custom_exceptions::parsing_error,
        "error after closing parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("(1 * 3) 5"),
        custom_exceptions::parsing_error,
        "error after closing parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("(((5)))          3333"),
        custom_exceptions::parsing_error,
        "error after closing parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("((12"),
    ...
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("1 * ((2+3) * 4"),
        custom_exceptions::parsing_error,
        "missing closing parenthesis");
    EXPECT_THROW_MSG(
        arithmetic::is_arithmetic_expression("(12 + 3) / (3 + 5"),
        custom_exceptions::parsing_error,
        "missing closing parenthesis");
    EXPECT_THROW_MSG(
