...
TEST(reverse_polish_notation, to_rpn_test)
{
    ...
    rpn_expression = arithmetic::to_rpn("0");
    ...
    rpn_expression = arithmetic::to_rpn("5*(8-3)*3+((3-1)*2)/3");
...
TEST(reverse_polish_notation, rpn_evaluate_test)
{
    ...
    EXPECT_EQ(
        arithmetic::rpn_evaluate(mock_operations, {"0"}), "0");
    EXPECT_EQ(
        arithmetic::rpn_evaluate(mock_operations, {"-0"}), "0");
    EXPECT_EQ(
        arithmetic::rpn_evaluate(mock_operations, {"95"}), "95");
    EXPECT_EQ(
        arithmetic::rpn_evaluate(mock_operations, {"-42"}), "-42");
    EXPECT_EQ(
        arithmetic::rpn_evaluate(mock_operations, {"000004121300"}),
        "4121300");
    EXPECT_EQ(
        arithmetic::rpn_evaluate(mock_operations, {"-00954"}), "-954");
    EXPECT_EQ(
        arithmetic::rpn_evaluate(mock_operations, {"123000"}), "123000");
    EXPECT_EQ(
        arithmetic::rpn_evaluate(mock_operations, {"99999999999999999999"}),
...

    {
        ...
        EXPECT_EQ(
            arithmetic::rpn_evaluate(mock_operations, {"2", "-3", "+"}), "-1");
...

    {
        ...
        EXPECT_EQ(
            arithmetic::rpn_evaluate(mock_operations, {"32", "-32", "-"}),
            "64");
        Mock::VerifyAndClearExpectations(&mock_operations);
    }
...

    {
        ...
        EXPECT_EQ(
            arithmetic::rpn_evaluate(mock_operations, {"9", "-31", "*"}),
            "-279");
        Mock::VerifyAndClearExpectations(&mock_operations);
    }

    {
        ...
        EXPECT_EQ(
            arithmetic::rpn_evaluate(mock_operations, {"9555", "32", "-"}),
            "9523");
        Mock::VerifyAndClearExpectations(&mock_operations);
    }

    {
        ...
        EXPECT_EQ(
            arithmetic::rpn_evaluate(mock_operations,
                {"-5", "-42", "/", "99", "-"}),
            "-99");
        Mock::VerifyAndClearExpectations(&mock_operations);
    }
